...
inputs:
    ...
    Example marching cubes:
        >>>python W04_assignment.py ...W01_Assignment/NIFTI/head.nii -f gaussian -t 100 150 250 2000 -op close -r cubes
    
    Example ray casting:
        >>>python W04_assignment.py ...W01_Assignment/NIFTI/head.nii -f gaussian -t -1000 -1000 -op none -r rays
...
defaultImg = 'C:/Users/mattd/Documents/GitHub/MDSC-689.03/W05_registration/Week_05_Assignment/DICOM/Sawbones'

defaultObj = 'C:/Users/mattd/Documents/GitHub/MDSC-689.03/W05_registration/Week_05_Assignment/SpineMesh/SawbonesSpine.obj'
...
objFile = defaultObj
filterType = 'gaussian'
thresh = [-900, -400, -900, -400] #, 0, 100]
lowThresh = thresh[0]
upperThresh = thresh[1]
if len(thresh) == 4:
    lowThresh2 = thresh[2]
    upperThresh2 = thresh[3]
operation = 'none'#'close'
renderType = 'cubes'
registration = 'y'
...
# objImage is the image to register to
# sourceImage is the image you want to transform to match the coordinates of objImage
# source3DImage is the medical image with marching cubes performed on it
# =============================================================================
def registerImage(objImage, sourceImage):
    ...
    # sourceTransformed.SetOutputOrigin(50.0,50.0,300.0)
